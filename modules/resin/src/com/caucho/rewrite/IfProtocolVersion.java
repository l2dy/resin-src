...
public class IfProtocolVersion implements RequestPredicate
{
  ...
  public boolean isMatch(HttpServletRequest request)
  {
    ...
    String protocol = (String) request.getAttribute("com.caucho.servlet.request.ssl-protocol");

    if (protocol == null || _pattern == null) {
      return false;
    }
    
    return _pattern.matcher(protocol).matches();
  }
}
